...
<section class="mt-9 bg-lime-300 dark:bg-rose-500 p-5 rounded-md">
    ...
    <div class="mt-4 grid grid-cols-2  sm:grid-cols-4 gap-x-5 gap-y-5">
        <div class="flex flex-col rounded-xl overflow-hidden aspect-square border dark:border-zinc-600" v-for="n in 8" :key="n">
            <img src="assets/pictures/Lemony-Snickets-Series-of-Unfortunate-Events.jpg" class=" h-4/5 object-cover w-full  " alt="">
